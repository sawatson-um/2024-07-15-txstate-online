...
latitude: "33.244759"        # decimal latitude of workshop venue (use https://www.latlong.net/)
longitude: "-95.909760"       # decimal longitude of the workshop venue (use https://www.latlong.net)
humandate: "July 15-16, 2024"    # human-readable dates for the workshop (e.g., "Feb 17-18, 2020")
...
instructor: ["Jay Gordon", "Urmi Poddar", "Anand Ruban Agarvas"] # boxed, comma-separated list of instructors' names as strings, like ["Kay McNulty", "Betty Jennings", "Betty Snyder"]
helper: ["Xuan Zhou", "Laura Waugh"]     # boxed, comma-separated list of helpers' names, like ["Marlyn Wescoff", "Fran Bilas", "Ruth Lichterman"]
email: ["x_zhou@txstate.edu"]    # boxed, comma-separated list of contact email addresses for the host, lead instructor, or whoever else is handling questions, like ["marlyn.wescoff@example.org", "fran.bilas@example.org", "ruth.lichterman@example.org"]
...
<p id="who-can-attend">
    ...
    This workshop is open to afilliates of Texas State University. If you are interested in attending this workshop, contact x_zhou@txstate.edu for more information.
</p>
{% endcomment %}
